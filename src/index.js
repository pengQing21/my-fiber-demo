...
function workloop(deadline) { 
    console.log("开始工作循环", deadline.timeRemaining());
    while (nextUnitOfWork&&deadline.timeRemaining()>0) { 
        console.log('work loop while ', nextUnitOfWork)
...
function performUnitOfWork(workingInProgressFiber) { 
    console.log('performUnitOfWork', workingInProgressFiber)
    beginWork(workingInProgressFiber);
    if (workingInProgressFiber.child) { 
        console.log('return workingInProgressFiber.child', workingInProgressFiber.child)
...
function beginWork(workingInProgressFiber) { 
    console.log("beginWork workingInProgressFiber:",workingInProgressFiber)
